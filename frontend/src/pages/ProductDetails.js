      ...
      {loading ? (
        ...
        <div className="flex flex-col md:flex-row items-start">
          ...
          <div className="w-full md:w-1/2">
            ...
            {/* Add to Cart Button */}
            <button className="mt-6 w-40 bg-cyan-600 hover:bg-cyan-700 text-white font-bold py-2 px-4 mx-1 rounded-lg transition duration-300">
              Buy Now
            </button>
            <button className="mt-6 w-40 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300">
              Add to Cart
            </button>
          </div>
        </div>
